...
<div class="section-hero wf-section">
    <div class="container">
        <div class="service-cover-wrapper">
            <img loading="lazy" src="../<?php echo htmlspecialchars($article['image_url']); ?>" alt="" class="service-cover-image" />
            <div class="absolute-service-head">
                <div class="banner-title-white"><?php echo htmlspecialchars($article['category']); ?></div>
...
<section class="section-150px">
    ...
    <div class="mb-20px">
        <h3 class="_30px-text">HIGHLIGHTS</h3>
    </div>
    <div class="mt-10px-mb-20px">
        <div class="divider"></div>
    </div>
    <div class="vertical-left-top _15px-gap">
        <a href="#tentang" class="horizontal-left-10px-gap" style="text-decoration: none; color: inherit;">
            <div class="_35px-icon-wrapper">
                <img loading="lazy" src="../images/check-mark.avif" alt="" class="_15px-image" />
            </div>
            <div class="font-500">Tentang</div>
        </a>
        <a href="#informasi-lengkap" class="horizontal-left-10px-gap" style="text-decoration: none; color: inherit;">
            <div class="_35px-icon-wrapper">
                <img loading="lazy" src="../images/check-mark.avif" alt="" class="_15px-image" />
            </div>
            <div class="font-500">Informasi Lengkap</div>
        </a>
        <a href="#lokasi" class="horizontal-left-10px-gap" style="text-decoration: none; color: inherit;">
            <div class="_35px-icon-wrapper">
                <img loading="lazy" src="../images/check-mark.avif" alt="" class="_15px-image" />
            </div>
            <div class="font-500">Lokasi</div>
        </a>
    </div>
