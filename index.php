  ...
  <div data-w-id="ea0483ae-d38f-61c7-1990-92beb1e755d2" class="site-wrapper">
    ...
    <div data-animation="over-left" class="navbar-rounded w-nav" data-easing2="ease" data-easing="ease-out-quart"
      ...
      <div class="w-layout-blockcontainer container nav-container w-container">
        <div class="navbar-main"><a data-w-id="ac2971f4-6f26-e7be-f7cd-a20c97325007" href="/" aria-current="page"
            class="w-inline-block w--current"><img src="images/agency-20logo.avif" loading="lazy" alt=""
              class="site-logo" /></a>
          <nav role="navigation" class="nav-menu-wrapper w-nav-menu">
            <div class="nav-menu-left-sidebar"><a href="/" data-w-id="783761a9-bb85-bb38-0e07-8475a4b307cb"
                aria-current="page" class="nav-link-wrapper w-inline-block w--current">
                <div class="nav-link">
                  ...
                  <div class="nav-dropdown-contents-body">
                    <div class="nav-dropdown-padding">
                      ...
                      <div class="nav-dropdown-links-block">
                        <div class="submenu-links-wrapper"><a href="/" aria-current="page"
...
" class="max-height-390px" />
        ...
        <div data-w-id="805a000d-bea4-146f-c7db-8e5eb907e47d" class="process-block"><a href="#"
            ...
            <div class="circle-inside-wrapper">
              <div class="circle-percentage-white">
                <h3 class="_24px-text-black">Steps</h3>
                <div class="steps">
          ...
          <div class="w-layout-vflex _50">
            ...
            <div class="process-card">
              ...
              <h3 class="_30px-title">Discovery &amp; Strategy</h3>
              <div class="margin-bottom-20px">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.
                </p>
              </div>
              <ul role="list" class="vertical-list">
                <li class="list-item">Client Meeting</li>
                <li class="list-item">Research market trends.</li>
                <li class="list-item">Create project roadmap.</li>
              </ul>
            </div>
            <div class="process-card z-2">
              <div class="icon-wrapper-90px"><img loading="lazy" src="images/web-design.avif" alt=""
                  class="image-45px" /></div>
              <h3 class="_30px-title">Design &amp; Development</h3>
              <div class="margin-bottom-20px">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.
                </p>
              </div>
              <ul role="list" class="vertical-list">
                ...
                <li class="list-item">sed do eiusmod tempor</li>
              </ul>
            </div>
            <div class="process-card z-3">
              <div class="icon-wrapper-90px"><img loading="lazy" src="images/database.webp" alt="" class="image-45px" />
              </div>
              <h3 class="_30px-title">Testing &amp; Optimization</h3>
              <div class="margin-bottom-20px">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.
                </p>
              </div>
            ...
            <div class="process-card z-4">
              <div class="icon-wrapper-90px"><img loading="lazy" src="images/startup-1.avif" alt=""
                  class="image-45px" /></div>
              <h3 class="_30px-title">Launch &amp; Support</h3>
              <div class="margin-bottom-20px">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.
                </p>
              </div>
      ...
      <div class="container">
        <div class="title-bar">
          ...
          <div class="product-bar-texts-vertical">
            ...
            <div data-w-id="f1a75d16-09b6-443b-a25b-8f49522648ba" class="text-merge-title">
              <h2 class="heading">Technologies We Use</h2>
              <div class="absolute-style-text"></div>
            </div>
          </div>
          <div class="_2px-height-border right"></div>
        ...
        <div class="tech-grid">
          <div id="w-node-_276990df-bbd0-492c-c639-698c3f43c878-13792a52" class="tech-circle-card">
            <div id="w-node-_276990df-bbd0-492c-c639-698c3f43c879-13792a52" class="circle"><img loading="lazy"
                src="images/webflow_logo_icon_169218.webp" alt="" class="image-70px" />
              <h3 class="_30px-text">Webflow</h3>
            </div>
            <div data-w-id="276990df-bbd0-492c-c639-698c3f43c87d"
              style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);transform-style:preserve-3d"
              class="gradient-color-full"></div>
            <div class="absolute-hover-color"></div>
          </div>
          <div id="w-node-_276990df-bbd0-492c-c639-698c3f43c87f-13792a52" class="tech-circle-card">
            <div class="circle"><img sizes="(max-width: 479px) 75vw, 70px"
            ...
            <div data-w-id="276990df-bbd0-492c-c639-698c3f43c884"
              style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);transform-style:preserve-3d"
              class="gradient-color-full"></div>
            <div class="absolute-hover-color"></div>
          </div>
          <div id="w-node-_276990df-bbd0-492c-c639-698c3f43c886-13792a52" class="tech-circle-card">
            <div class="circle"><img sizes="(max-width: 479px) 75vw, 70px"
            ...
            <div data-w-id="276990df-bbd0-492c-c639-698c3f43c88b"
              style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);transform-style:preserve-3d"
              class="gradient-color-full"></div>
            <div class="absolute-hover-color"></div>
          </div>
          <div id="w-node-_276990df-bbd0-492c-c639-698c3f43c88d-13792a52" class="tech-circle-card">
            ...
            <div data-w-id="276990df-bbd0-492c-c639-698c3f43c892"
              style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(null) rotateZ(0deg) skew(0, 0);transform-style:preserve-3d"
              class="gradient-color-full"></div>
            <div class="absolute-hover-color"></div>
          </div>
    ...
    <section data-w-id="69f36155-e088-485d-58ea-29e5ef88a9d4" class="horizontal-slider-section">
      <div class="camera">
              ...
              <div role="list" class="portfolio-horizontal w-dyn-items">
                <div role="listitem" class="full-image w-dyn-item"><a data-w-id="d945ec06-2068-2df4-5892-acfa5542b07b"
                    href="/project/portfolio-for-photography-studio" class="portfolio-card w-inline-block"><img
                      src="images/2148019213.avif" loading="lazy" alt="" sizes="(max-width: 767px) 32vw, 33vw"
                    ...
                    <div class="portfolio-info-card">
                      <h3 class="_20px-text-black">Portfolio for Photography Studio</h3>
                    </div>
                  </a></div>
                <div role="listitem" class="full-image w-dyn-item"><a data-w-id="d945ec06-2068-2df4-5892-acfa5542b07b"
                    href="/project/motion-graphics-for-product-launch" class="portfolio-card w-inline-block"><img
                      src="images/31235.avif" loading="lazy" alt="" sizes="(max-width: 767px) 32vw, 33vw"
                      srcset="images/31235-p-500.avif 500w, images/31235-p-800.avif 800w, images/31235.avif 1500w"
                      class="portfolio-thumbnail" />
                    <div class="black-overlay"></div>
                    <div class="portfolio-info-card">
                      <h3 class="_20px-text-black">Motion Graphics for Product Launch</h3>
                    </div>
                  </a></div>
                <div role="listitem" class="full-image w-dyn-item"><a data-w-id="d945ec06-2068-2df4-5892-acfa5542b07b"
                    href="/project/seo-optimization-project" class="portfolio-card w-inline-block"><img
                      src="images/77.avif" loading="lazy" alt="" sizes="(max-width: 767px) 32vw, 33vw"
                      srcset="images/77-p-500.avif 500w, images/77-p-800.avif 800w, images/77.avif 1500w"
                      class="portfolio-thumbnail" />
                    <div class="black-overlay"></div>
                    <div class="portfolio-info-card">
                      <h3 class="_20px-text-black">SEO Optimization for Local Business</h3>
                    </div>
                  </a></div>
              </div>
            </div>
              ...
              <div role="list" class="portfolio-horizontal w-dyn-items">
                <div role="listitem" class="full-image w-dyn-item"><a data-w-id="d945ec06-2068-2df4-5892-acfa5542b07b"
                    href="/project/digital-marketing-campaign-for-startup" class="portfolio-card w-inline-block"><img
                      src="images/94833.avif" loading="lazy" alt="" sizes="(max-width: 767px) 32vw, 33vw"
                      srcset="images/94833-p-500.avif 500w, images/94833-p-800.avif 800w, images/94833.avif 1500w"
                      class="portfolio-thumbnail" />
                    <div class="black-overlay"></div>
                    <div class="portfolio-info-card">
                      <h3 class="_20px-text-black">Digital Marketing Campaign for Startup</h3>
                    </div>
                  </a></div>
                <div role="listitem" class="full-image w-dyn-item"><a data-w-id="d945ec06-2068-2df4-5892-acfa5542b07b"
                    href="/project/responsive-web-design-project" class="portfolio-card w-inline-block"><img
                      src="images/pexels-tranmautritam-326501.avif" loading="lazy" alt=""
                    ...
                    <div class="black-overlay"></div>
                    <div class="portfolio-info-card">
                      <h3 class="_20px-text-black">Responsive Web Design for Non-Profit</h3>
                    </div>
                  </a></div>
                <div role="listitem" class="full-image w-dyn-item"><a data-w-id="d945ec06-2068-2df4-5892-acfa5542b07b"
                    href="/project/branding-project" class="portfolio-card w-inline-block"><img
                      src="images/pexels-eva-bronzini-7661590.avif" loading="lazy" alt=""
                      sizes="(max-width: 767px) 32vw, 33vw"
                    ...
                    <div class="black-overlay"></div>
                    <div class="portfolio-info-card">
                      <h3 class="_20px-text-black">Branding and Identity for Tech Startup</h3>
                    </div>
                  </a></div>
              </div>
            </div>
        ...
        </div><a href="#" class="circle-percentage w-inline-block">
          <div class="circle-inside-wrapper">
            <div class="circle-percentage-white">
              <h2 class="_30px-text-black">Projects</h2>
            </div>
            <div class="circle-percentage-color"></div>
          </div>
        </a>
      ...
      <div class="container">
        <div class="title-bar">
          ...
          <div class="product-bar-texts-vertical">
            ...
            <div data-w-id="f1a75d16-09b6-443b-a25b-8f49522648ba" class="text-merge-title">
              <h2 class="heading">Review From Our Customers</h2>
              <div class="absolute-style-text"></div>
            </div>
          </div>
          <div class="_2px-height-border right"></div>
        ...
        <div class="testimonial-container">
          <div data-w-id="03b75ead-4f93-cb93-b5b1-6ba555aa00a9"
            style="-webkit-transform:translate3d(0, 0%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 0%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
            class="testimonials-vertical-wrapper">
              ...
              <div class="testimonial-contents-5px-gap">
                <div class="space-between-center"><img loading="lazy" src="images/right.png" alt=""
                  ...
                  <div class="w-layout-hflex testimonial-star-wrapper">
                    <div class="_16px-star-icon">star</div>
                    <div class="_16px-star-icon">star</div>
                    <div class="_16px-star-icon">star</div>
                    <div class="_16px-star-icon">star</div>
                    <div class="_16px-star-icon">star</div>
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/32957.avif" loading="lazy" alt="" sizes="45px"
                      srcset="images/32957-p-500.avif 500w, images/32957-p-800.avif 800w, images/32957-p-1080.avif 1080w, images/32957.avif 1500w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">John Smith</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            </div>
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/7091.avif" loading="lazy" alt=""
                      sizes="(max-width: 479px) 100vw, 45px"
                      srcset="images/7091-p-500.avif 500w, images/7091-p-800.avif 800w, images/7091-p-1080.avif 1080w, images/7091.avif 1500w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Lisa Roberts</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/162638.avif" loading="lazy" alt=""
                      sizes="45px"
                      srcset="images/162638-p-500.avif 500w, images/162638-p-800.avif 800w, images/162638-p-1080.avif 1080w, images/162638.avif 1500w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Roy Evans</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/3542.avif" loading="lazy" alt="" sizes="45px"
                      srcset="images/3542-p-500.avif 500w, images/3542-p-800.avif 800w, images/3542-p-1080.avif 1080w, images/3542.avif 1500w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Kevin Clint</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/677.avif" loading="lazy" alt="" sizes="45px"
                      srcset="images/677-p-500.avif 500w, images/677-p-800.avif 800w, images/677-p-1080.avif 1080w, images/677.avif 1500w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Daniel Carter</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/88087.avif" loading="lazy" alt=""
                      sizes="(max-width: 479px) 100vw, 45px"
                      srcset="images/88087-p-500.avif 500w, images/88087-p-800.avif 800w, images/88087-p-1080.avif 1080w, images/88087.avif 1500w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Jennifer Jolie</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
          ...
          <div data-w-id="03b75ead-4f93-cb93-b5b1-6ba555aa0146"
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/15569.avif" loading="lazy" alt=""
                      sizes="(max-width: 767px) 100vw, 45px"
                      srcset="images/15569-p-500.avif 500w, images/15569-p-800.avif 800w, images/15569-p-1080.avif 1080w, images/15569.avif 1500w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Brian Lewis</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/13154.avif" loading="lazy" alt=""
                      sizes="(max-width: 767px) 100vw, 45px"
                      srcset="images/13154-p-500.avif 500w, images/13154-p-800.avif 800w, images/13154-p-1080.avif 1080w, images/13154.avif 1500w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Olivia Scott</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/18778.avif" loading="lazy" alt=""
                      sizes="(max-width: 767px) 100vw, 45px"
                      srcset="images/18778-p-500.avif 500w, images/18778-p-800.avif 800w, images/18778-p-1080.avif 1080w, images/18778.avif 1500w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">David Mark</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/vinicius-wiesehofer-uoavp_z38le-unsplash.avif"
                      loading="lazy" alt="" sizes="(max-width: 767px) 100vw, 45px"
                      srcset="images/vinicius-wiesehofer-uoavp_z38le-unsplash-p-500.jpg 500w, images/vinicius-wiesehofer-uoavp_z38le-unsplash-p-800.jpg 800w, images/vinicius-wiesehofer-uoavp_z38le-unsplash-p-1080.jpg 1080w, images/vinicius-wiesehofer-uoavp_z38le-unsplash-p-1600.jpg 1600w, images/vinicius-wiesehofer-uoavp_z38le-unsplash.avif 1920w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Emma Steve</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/wepik-export-20230912063007f2fv-201.avif"
                      loading="lazy" alt="" sizes="(max-width: 767px) 100vw, 45px"
                      srcset="images/wepik-export-20230912063007f2fv-25201-p-500.avif 500w, images/wepik-export-20230912063007f2fv-201.avif 789w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">John Reed</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/13487.webp" loading="lazy" alt=""
                      sizes="(max-width: 767px) 100vw, 45px" srcset="images/13487.webp 500w, images/13487.webp 768w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">R.Isabella</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
          ...
          <div data-w-id="03b75ead-4f93-cb93-b5b1-6ba555aa01e3"
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/2148493050.avif" loading="lazy" alt=""
                      sizes="(max-width: 991px) 100vw, 45px"
                      srcset="images/2148493050-p-500.avif 500w, images/2148493050-p-800.avif 800w, images/2148493050.avif 1000w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Lea Armas</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/23540.avif" loading="lazy" alt=""
                      sizes="(max-width: 991px) 100vw, 45px"
                      srcset="images/23540-p-500.jpg 500w, images/23540-p-800.jpg 800w, images/23540-p-1080.jpg 1080w, images/23540.avif 1500w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Steve Doe</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/2148095762.avif" loading="lazy" alt=""
                      sizes="(max-width: 991px) 100vw, 45px"
                      srcset="images/2148095762-p-500.avif 500w, images/2148095762-p-800.avif 800w, images/2148095762.avif 1000w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Orion Clark</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img
                      src="images/christopher-campbell-rdeovte7vos-unsplash.avif" loading="lazy" alt=""
                      sizes="(max-width: 991px) 100vw, 45px"
                      srcset="images/christopher-campbell-rdeovte7vos-unsplash-p-500.avif 500w, images/christopher-campbell-rdeovte7vos-unsplash-p-800.avif 800w, images/christopher-campbell-rdeovte7vos-unsplash-p-1080.avif 1080w, images/christopher-campbell-rdeovte7vos-unsplash-p-1600.avif 1600w, images/christopher-campbell-rdeovte7vos-unsplash.avif 1920w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">T.Steaphny</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/7770.avif" loading="lazy" alt=""
                      sizes="(max-width: 991px) 100vw, 45px" srcset="images/7770-p-500.avif 500w, images/7770.avif 752w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Zack Ryan</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
            ...
            <div class="testimonial-white-30px-padding">
              <div class="testimonial-contents-5px-gap">
                ...
                <div class="horizontal-left-center-15px-gap">
                  <div class="testimonial-image-wrapper"><img src="images/2147989567.avif" loading="lazy" alt=""
                      sizes="(max-width: 991px) 100vw, 45px"
                      srcset="images/2147989567-p-500.avif 500w, images/2147989567-p-800.avif 800w, images/2147989567.avif 1000w"
                      class="testimonial-client-image" /></div>
                  <div class="vertical-left-top">
                    <h3 class="_20px-title">Lady Malkova</h3>
                    <div class="_14px-text">Customer</div>
                  </div>
                </div>
              </div>
    ...
    <section class="section">
      <div class="container">
        <div class="_2-column-block-top">
          <div class="w-layout-vflex pricing-contents-block">
            <div class="mask">
              <h2 data-w-id="56ba0106-dafd-92a5-0cea-399ad9d63faf"
                style="-webkit-transform:translate3d(0, 70%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 70%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 70%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 70%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0"
                class="heading">Pricing</h2>
            </div>
            <div class="max-width-282px">
              <div class="mask">
                <p data-w-id="56ba0106-dafd-92a5-0cea-399ad9d63fb3"
                  style="-webkit-transform:translate3d(0, 70%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 70%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 70%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 70%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0"
                  class="text">Take a look at some of our recent projects to see how we&#x27;ve helped businesses like
                  yours succeed online.</p>
              </div>
            </div>
            <div data-w-id="3aa175d3-aec0-87d4-b4df-998482ee7510" class="meeting-card">
              <div class="max-width-243px">
                <div class="_30px-text">Let’s Schedule a Meeting</div>
              </div><a href="/contact-1" data-w-id="b6951e6b-60e9-44a3-42d0-c76a6d52a492"
                class="nx-button-wrapper w-inline-block">
                <div class="button">
                  <div class="button-text-wrapper">
          ...
          <div class="full-width w-dyn-list">
            <div role="list" class="pricing-cards w-dyn-items">
              <div role="listitem" class="w-dyn-item">
                <div class="pricing-card-horizontal">
                  <div class="w-layout-vflex pricing-package-name">
                    <h3 class="heading">Enterprise</h3>
                    <p>Perfect for startups and small businesses.</p>
                  </div>
                  <div class="pricing-list w-richtext">
                    <ul role="list">
                      <li>Website with API Integration</li>
                      <li>Responsive Design</li>
                      <li>SEO &amp; Analytics Tracking</li>
                      <li>CMS Integration &amp; Support</li>
                      <li>E-commerce Integration</li>
                    </ul>
                  </div>
                  <div class="w-layout-vflex _18px-gap">
                    <div class="price-text-wrapper">
                      <h4 data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                        class="price-28px">$ 2,500.00 USD</h4>
                    </div><a href="/product/enterprise" data-w-id="c2f37c5e-217f-e0b2-c837-63297c2dd139"
                      class="white-button w-inline-block">
                      <div class="button-text-wrapper">
                ...
                <div class="mask w-condition-invisible">
                  <div class="pricing-card-horizontal featured">
                    <div class="w-layout-vflex pricing-package-name">
                      <h3 class="heading black">Enterprise</h3>
                      <p class="text-black">Ideal for growing businesses looking for advanced features.</p>
                    </div>
                    <div class="pricing-list featured w-richtext">
                      <ul role="list">
                        <li>Website with API Integration</li>
                        <li>Responsive Design</li>
                        <li>SEO &amp; Analytics Tracking</li>
                    ...
                    <div class="w-layout-vflex _18px-gap">
                      <div class="price-text-wrapper">
                        <h4 data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                          class="price-28px black">$ 2,500.00 USD</h4>
                      </div><a href="/product/enterprise" data-w-id="05cebf46-bb4f-1d75-ba24-0d8fe8be3d30"
                  ...
                  <div class="featured-text">
                    <div class="featured-inverted-left"></div>
                    <div>Featured</div>
                    <div class="featured-inverted-right"></div>
                  </div>
                </div>
              </div>
              <div role="listitem" class="w-dyn-item">
                <div class="pricing-card-horizontal w-condition-invisible">
                  <div class="w-layout-vflex pricing-package-name">
                  ...
                  <div class="w-layout-vflex _18px-gap">
                    <div class="price-text-wrapper">
                      <h4 data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                        class="price-28px">$ 1,200.00 USD</h4>
                    </div><a href="/product/professional" data-w-id="c2f37c5e-217f-e0b2-c837-63297c2dd139"
                      class="white-button w-inline-block">
                      <div class="button-text-wrapper">
                        <div>View Details</div>
                      </div>
                ...
                <div class="mask">
                  <div class="pricing-card-horizontal featured">
                    <div class="w-layout-vflex pricing-package-name">
                      <h3 class="heading black">Professional</h3>
                      <p class="text-black">Ideal for growing businesses looking for advanced features.</p>
                    </div>
                    <div class="pricing-list featured w-richtext">
                      <ul role="list">
                    ...
                    <div class="w-layout-vflex _18px-gap">
                      <div class="price-text-wrapper">
                        <h4 data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                          class="price-28px black">$ 1,200.00 USD</h4>
                      </div><a href="/product/professional" data-w-id="05cebf46-bb4f-1d75-ba24-0d8fe8be3d30"
                        class="secondary-button w-inline-block">
                        <div class="button-text-wrapper">
                          <div>View Details</div>
                        </div>
              ...
              <div role="listitem" class="w-dyn-item">
                <div class="pricing-card-horizontal">
                  ...
                  <div class="w-layout-vflex _18px-gap">
                    <div class="price-text-wrapper">
                      <h4 data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                        class="price-28px">$ 500.00 USD</h4>
                    </div><a href="/product/startup" data-w-id="c2f37c5e-217f-e0b2-c837-63297c2dd139"
                      class="white-button w-inline-block">
                      <div class="button-text-wrapper">
                        <div>View Details</div>
                      </div>
                ...
                <div class="mask w-condition-invisible">
                  <div class="pricing-card-horizontal featured">
                    <div class="w-layout-vflex pricing-package-name">
                      <h3 class="heading black">Startup</h3>
                      <p class="text-black">Ideal for growing businesses looking for advanced features.</p>
                    </div>
                    <div class="pricing-list featured w-richtext">
                      <ul role="list">
                    ...
                    <div class="w-layout-vflex _18px-gap">
                      <div class="price-text-wrapper">
                        <h4 data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                          class="price-28px black">$ 500.00 USD</h4>
                      </div><a href="/product/startup" data-w-id="05cebf46-bb4f-1d75-ba24-0d8fe8be3d30"
                        class="secondary-button w-inline-block">
                        <div class="button-text-wrapper">
                          <div>View Details</div>
                        </div>
    ...
    <section class="section">
      <div class="container">
        <div class="contents">
          ...
          <h2 class="heading">Your Service Related Questions, Answered Here</h2>
        </div>
        <div class="_2-column-block-top">
          <div class="faq-tab-menu">
            <div data-hover="false" data-delay="0" class="dropdown-faq-block w-dropdown">
              <div class="dropdown-switch w-dropdown-toggle">
                <div class="dropdown-title">1. What services do you offer?</div>
                <div class="_40px-rounded-border-icon">
                  <div>chevron_right</div>
                </div>
              </div>
              <nav class="dropdown-contents w-dropdown-list">
                <p class="dropdown-texts">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
            ...
            <div data-hover="false" data-delay="0" class="dropdown-faq-block w-dropdown">
              <div class="dropdown-switch w-dropdown-toggle">
                <div class="dropdown-title">2. How do we start working together?</div>
                <div class="_40px-rounded-border-icon">
                  <div>chevron_right</div>
                </div>
              </div>
            ...
            <div data-hover="false" data-delay="0" class="dropdown-faq-block w-dropdown">
              <div class="dropdown-switch w-dropdown-toggle">
                <div class="dropdown-title">3. What industries do you work with?</div>
                <div class="_40px-rounded-border-icon">
                  <div>chevron_right</div>
                </div>
              </div>
            ...
            <div data-hover="false" data-delay="0" class="dropdown-faq-block w-dropdown">
              <div class="dropdown-switch w-dropdown-toggle">
                <div class="dropdown-title">4. How long does a typical project take?</div>
                <div class="_40px-rounded-border-icon">
                  <div>chevron_right</div>
                </div>
              </div>
            ...
            <div data-hover="false" data-delay="0" class="dropdown-faq-block w-dropdown">
              <div class="dropdown-switch w-dropdown-toggle">
                <div class="dropdown-title">5. Do you offer ongoing support?</div>
                <div class="_40px-rounded-border-icon">
                  <div>chevron_right</div>
                </div>
              </div>
            ...
            <div data-hover="false" data-delay="0" class="dropdown-faq-block w-dropdown">
              <div class="dropdown-switch w-dropdown-toggle">
                <div class="dropdown-title">6. How much do your services cost?</div>
                <div class="_40px-rounded-border-icon">
                  <div>chevron_right</div>
                </div>
              </div>
            ...
            <div data-hover="false" data-delay="0" class="dropdown-faq-block w-dropdown">
              <div class="dropdown-switch w-dropdown-toggle">
                <div class="dropdown-title">7. Can I see samples of your work?</div>
                <div class="_40px-rounded-border-icon">
                  <div>chevron_right</div>
                </div>
              </div>
            ...
            <div data-hover="false" data-delay="0" class="dropdown-faq-block w-dropdown">
              <div class="dropdown-switch w-dropdown-toggle">
                <div class="dropdown-title">8. How involved can I be in the design process?</div>
                <div class="_40px-rounded-border-icon">
                  <div>chevron_right</div>
                </div>
              </div>
          ...
          <div class="faq-image-wrapper"><img sizes="(max-width: 767px) 97vw, (max-width: 991px) 98vw, 47vw"
              srcset="images/toa-heftiba-4xe-yvfjcvw-unsplash-p-500.avif 500w, images/toa-heftiba-4xe-yvfjcvw-unsplash-p-800.avif 800w, images/toa-heftiba-4xe-yvfjcvw-unsplash-p-1080.avif 1080w, images/toa-heftiba-4xe-yvfjcvw-unsplash.avif 1920w"
              alt="Office Meeting
" src="images/toa-heftiba-4xe-yvfjcvw-unsplash.avif" loading="lazy" class="image-660px-height" />
            <div class="faq-image-contents">
              <div>
                <h3 class="_24px-title-bold">Mail Us In Emergency!</h3>
              </div>
              <div><a href="/contact-1" data-w-id="bbe70ef4-67d7-8d67-30dc-46a75f07dbd9"
                  class="white-button w-inline-block">
                  <div class="button-text-wrapper">
                    <div class="default-text">Contact Us</div>
                    <div class="default-text">Contact Us</div>
    ...
    <section class="section">
      <div class="container">
        <div class="cta-conainer">
          <div class="contents-full">
            <p>We would love to hear from you</p>
            <div class="margin-20px">
              <h2 class="heading">get in touch with us</h2>
            </div>
            <div class="horizontal-left-center-30px-gap-wrap">
              <div class="horizontal-left-center-15px-gap"><img src="images/phone-call.avif" loading="lazy" alt=""
                  class="image-16px" />
                <p>(415) 555‑0XX2</p>
              </div>
              <div class="horizontal-left-center-15px-gap"><img src="images/email-20-3-.avif" loading="lazy" alt=""
                  class="image-16px" />
                <p>nexoyXX@gmail.com</p>
              </div>
            </div>
          </div>
          <div class="_2-col-grid">
            <div id="w-node-_9e535121-7c35-4b2c-f3c4-b1d7395b5099-395b5086"><a href="/contact-1"
                data-w-id="bbe70ef4-67d7-8d67-30dc-46a75f07dbd9" class="white-button w-inline-block">
                <div class="button-text-wrapper">
                  <div class="default-text">Contact Us</div>
                  <div class="default-text">Contact Us</div>
                </div>
            ...
            <div id="w-node-_9e535121-7c35-4b2c-f3c4-b1d7395b509c-395b5086"><a href="/services-1"
                data-w-id="7e33fa6d-bf4c-a683-438d-941a73dca7da" class="primary-button w-inline-block">
                <div class="button-text-wrapper">
                  <div class="default-text">View Services</div>
                  <div class="default-text black-heading">View Services</div>
                </div>
                <div class="absolute-hover-bottom"></div>
              </a></div>
          </div>
            ...
            <div role="listitem" class="w-dyn-item">
              <div data-w-id="3aa9b968-98e2-906a-c7d1-034fdca8e2e9" class="blog-card">
                <div class="blog-thubnail-mask"><a href="/post/effective-client-communication-strategies"
                    class="mask-10px-rounded-full w-inline-block"><img src="images/image17.avif" loading="lazy" alt=""
                      class="blog-thumbnail-300px" /></a><a href="/blog-categories/agency"
                    class="blog-category w-inline-block">
                    <div class="blog-category-left-shape"></div>
                    <div>Agency</div>
                    <div class="blog-category-right-shape"></div>
